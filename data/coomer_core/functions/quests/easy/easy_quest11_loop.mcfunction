...
#check for a winner
execute if score CurrentQ_easy QuestID matches 11 as @a[scores={CurrentQ_easy=0},predicate=coomer_core:biome_checkers/nether_wastes] run function coomer_core:quests/easy/easy_quest11_win