...
#check for a winner
execute if score CurrentQ_med QuestID matches <QUEST_ID> as @a[scores={CurrentQ_med=0,med_quest=15..}] run function coomer_core:quests/med/med_quest<QUEST_ID>_win